...
public class SandboxListas
{
    ...
    {
    	int[] enterosArreglo = new int[listaEnteros.size()];
    	for(int i = 0; i < listaEnteros.size(); i++)
    	{
    		enterosArreglo[i] = listaEnteros.get(i);
    	}
    	
        return enterosArreglo;
    }
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        for (int i = 0; i < listaEnteros.size(); i++) 
        {
            ...
            {
                if (listaEnteros.get(i).equals(listaEnteros.get(j)) && !contados.contains(listaEnteros.get(i)))
                {
                    contador++;
                    contados.add(listaEnteros.get(i));
                }
            }
        }
        return contador;
