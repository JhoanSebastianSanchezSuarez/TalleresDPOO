...
public class SandboxMapas
{
    ...
    {
    	Set<String> valores = new HashSet<String>(mapaCadenas.values());
    	int cantidadUnicos = valores.size();
    	return cantidadUnicos;
    ...
    public void volverMayusculas( )
    {
        ...
        for (Map.Entry<String, String> pareja : mapaCadenas.entrySet()) 
        {
            mapaTemporal.put(pareja.getKey().toUpperCase(), pareja.getValue());
        }
