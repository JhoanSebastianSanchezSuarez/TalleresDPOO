...
public class SandboxConjuntos
{
    ...
    {
        List<String> listaCadenasMayor = new ArrayList<String>(arbolCadenas);
        Collections.reverse(listaCadenasMayor);
        return listaCadenasMayor;
    ...
    {
    	NavigableSet <String> mayusculas = new TreeSet<String>();
