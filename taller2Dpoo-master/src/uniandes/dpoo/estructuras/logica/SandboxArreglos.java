...
public class SandboxArreglos
{
    ...
    {
    	int[] enteros2 = new int[arregloEnteros.length];
    	for(int i = 0; i < arregloEnteros.length; i++)
    	{
    		enteros2[i] = arregloEnteros[i];
    	}
        return enteros2;
    }
    ...
    {
    	String[] cadenas2 = new String[arregloCadenas.length];
    	for(int i = 0; i < arregloCadenas.length; i++)
    	{
    		cadenas2[i] = arregloCadenas[i];
    	}
        return cadenas2;
    }
    ...
    {
    	int[] arregloNuevo = new int[arregloEnteros.length];
    	int j = 0;
    	for(int i = 0; i < arregloEnteros.length; i++)
    	{
    		if(arregloNuevo[i] != valor)
    		{
    ...
    {
    	String[] arregloNuevo = new String[arregloCadenas.length];
    	int j = 0;
    	for(int i = 0; i < arregloCadenas.length; i++)
    	{
    		if(arregloNuevo[i] != cadena)
    		{
    ...
    public void volverPositivos( )
    {
    	for(int i = 0; i < this.arregloEnteros.length; i++)
        {
            ...
            {
                this.arregloEnteros[i] = arregloEnteros[i] * -1;
            }
        }
    }
    ...
    public int[] calcularRangoEnteros( )
    {
    	...
    	Arrays.sort(arregloEnteros);
    	maxMin[0] = arregloEnteros[0];
    	maxMin[1] = arregloEnteros[arregloEnteros.length - 1];
